const images = [
  ...
  //Додати список з майбутніми зображеннями//
  const imageEl = document.querySelector('.gallery');

  //Згенеревути ШР з розміткою зображення//
  ...
  //додати обробник подій на клік картинки//
...
//використати бібліотеку для додавання модального вікна//
